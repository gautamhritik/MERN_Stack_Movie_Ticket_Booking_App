    ...
    <div className="px-6 md:px-16 lg:px-40 pt-32 md:pt-48">
      <div className="flex flex-col md:flex-row gap-8 max-w-5xl mx-auto">
        <img
          ...
          alt="Movie Poster"
          className="w-56 md:w-64 lg:w-72 aspect-[2/3] rounded-xl object-cover shadow-md"
        />
        <div className="relative flex flex-col gap-3">
          <BlurCircle top="-100px" left="-100px" className="pointer-events-none -z-10" />

          <p className="text-primary">ENGLISH</p>

          <h1 className="text-4xl font-semibold max-w-80 text-balance z-10">
            {show.movie.title}
          </h1>
          <div className="flex items-center gap-2 text-gray-300 z-10">
